...
El arnés automático (`python -m skudo.acceptance.s0`) comprueba tres de los
cuatro criterios del spec: espejo sincronizado, un registro por store view con
la población completa de cada tienda, procedencia de scope e identidad de
opciones. **La latencia de sincronización de deltas no se mide en ninguna
parte**, ni en el arnés ni en los tests: es el punto 4 de esta lista y hoy es
la única vía de conocer ese número.

Estas cinco comprobaciones necesitan ojo humano y se hacen una vez, antes de
